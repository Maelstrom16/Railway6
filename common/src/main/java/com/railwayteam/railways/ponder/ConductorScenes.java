...
public class ConductorScenes {
  ...
  public static ElementLink<EntityElement> makePlayerStand(SceneBuilder builder, String playerName, int leatherColor, Vec3 pos) {
  ...
  public static void constructing(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    scene.overlay().showControls(util.vector().blockSurface(casing, Direction.UP), Pointing.DOWN, 40)
        .rightClick()
        .withItem(CRItems.ITEM_CONDUCTOR_CAP.get(DyeColor.RED)
        .asStack());
