...
public class DoorScenes {
    public static void modes(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.overlay().showText(60)
            ...
            .attachKeyFrame();
        scene.idle(30);
        scene.overlay().showControls(upperDoorSurface, Pointing.DOWN, 20)
            .rightClick();
        scene.idle(10);
...
//        scene.world().hideSection(lowerFloorCutout, Direction.DOWN);
        ...
        scene.overlay().showControls(util.vector().topOf(elevatorDoorBottomPos.below(6)).add(8 / 16f, 0, 0), Pointing.DOWN, 60)
            .rightClick();
        ...
        scene.overlay().showControls(util.vector().topOf(elevatorDoorBottomPos.below(6)).add(8 / 16f, 0, 0), Pointing.DOWN, 50)
            .rightClick()
            .whileSneaking();
        scene.overlay().showText(60)
            .colored(PonderPalette.GREEN)
