...
public class CRBogeyStyles {
    ...
    public static final CategoryEntry STANDARD_CATEGORY = registerCategory(Create.ID, STANDARD_CYCLE_GROUP.getPath());
    ...
    public static final BogeyStyle MONOBOGEY = create("monobogey", "monobogey")
        ...
        .size(BogeySizes.SMALL, CRBlocks.MONO_BOGEY, () -> () -> new SizeRenderer(new MonoBogeyRenderer(), StandardBogeyVisual::new))
        .build();

    public static final BogeyStyle INVISIBLE = create("invisible", Create.asResource(STANDARD_CYCLE_GROUP.getPath()))
        .displayName(Component.translatable("railways.bogeys.styles.invisible"))
        .size(BogeySizes.SMALL, CRBlocks.INVISIBLE_BOGEY, () -> () -> new SizeRenderer(new InvisibleBogeyRenderer(), StandardBogeyVisual::new))
    ...
    public static final BogeyStyle INVISIBLE_MONOBOGEY = create("invisible_monobogey", "monobogey")
        ...
        .size(BogeySizes.SMALL, CRBlocks.INVISIBLE_MONO_BOGEY, () -> () -> new SizeRenderer(new InvisibleBogeyRenderer(), StandardBogeyVisual::new))
        .contactParticle(new CubeParticleData())
        .build();
    ...
    public static final BogeyStyle
        SINGLEAXLE = create("singleaxle", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY, () -> () -> new SizeRenderer(new SingleaxleBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        LEAFSPRING = create("leafspring", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY, () -> () -> new SizeRenderer(new LeafspringBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        COILSPRING = create("coilspring", SINGLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.SINGLEAXLE_BOGEY, () -> () -> new SizeRenderer(new CoilspringBogeyRenderer(), StandardBogeyVisual::new))
            .build();

    // Double Axles
    public static final BogeyStyle
        FREIGHT = create("freight", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new FreightBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        ARCHBAR = create("archbar", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new ArchbarBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        PASSENGER = create("passenger", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new PassengerBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        MODERN = create("modern", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new ModernBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        BLOMBERG = create("blomberg", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new BlombergBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        Y25 = create("y25", DOUBLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.LARGE_PLATFORM_DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new Y25BogeyRenderer(), StandardBogeyVisual::new))
            .build();

    // Triple Axles
    public static final BogeyStyle
        HEAVYWEIGHT = create("heavyweight", TRIPLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.TRIPLEAXLE_BOGEY, () -> () -> new SizeRenderer(new HeavyweightBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        RADIAL = create("radial", TRIPLEAXLE_CYCLE_GROUP)
            .size(BogeySizes.SMALL, CRBlocks.TRIPLEAXLE_BOGEY, () -> () -> new SizeRenderer(new RadialBogeyRenderer(), StandardBogeyVisual::new))
            .build();

    // Wide Bogeys
    public static final BogeyStyle
        WIDE_DEFAULT = create("wide_default", Create.asResource(STANDARD_CYCLE_GROUP.getPath()))
            .displayName(Component.translatable("railways.bogeys.styles.wide_default"))
            .size(BogeySizes.SMALL, CRBlocks.WIDE_DOUBLEAXLE_BOGEY, () -> () -> new SizeRenderer(new WideDefaultBogeyRenderer(), StandardBogeyVisual::new))
            .size(BogeySizes.LARGE, CRBlocks.WIDE_SCOTCH_BOGEY, () -> () -> new SizeRenderer(new WideScotchYokeBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        WIDE_COMICALLY_LARGE = create("wide_comically_large", Create.asResource(STANDARD_CYCLE_GROUP.getPath()))
            .displayName(Component.translatable("railways.bogeys.styles.wide_comically_large"))
            .size(BogeySizes.LARGE, CRBlocks.WIDE_COMICALLY_LARGE_BOGEY, () -> () -> new SizeRenderer(new WideComicallyLargeScotchYokeBogeyRenderer(), StandardBogeyVisual::new))
            .build();

    // Narrow Bogeys
    public static final BogeyStyle
        NARROW_DEFAULT = create("narrow_default", Create.asResource(STANDARD_CYCLE_GROUP.getPath()))
            .displayName(Component.translatable("railways.bogeys.styles.narrow_default"))
            .size(BogeySizes.SMALL, CRBlocks.NARROW_SMALL_BOGEY, () -> () -> new SizeRenderer(new NarrowSmallBogeyRenderer(), StandardBogeyVisual::new))
            .size(BogeySizes.LARGE, CRBlocks.NARROW_SCOTCH_BOGEY, () -> () -> new SizeRenderer(new NarrowScotchYokeBogeyRenderer(), StandardBogeyVisual::new))
            .build(),
        NARROW_DOUBLE_SCOTCH = create("narrow_double_scotch", Create.asResource(STANDARD_CYCLE_GROUP.getPath()))
            .displayName(Component.translatable("railways.bogeys.styles.narrow_double_scotch"))
            .size(BogeySizes.LARGE, CRBlocks.NARROW_DOUBLE_SCOTCH_BOGEY, () -> () -> new SizeRenderer(new NarrowDoubleScotchYokeBogeyRenderer(), StandardBogeyVisual::new))
            .build();

    // Handcar
    public static final BogeyStyle HANDCAR = create("handcar", "handcar_cycle_group")
        .size(BogeySizes.SMALL, CRBlocks.HANDCAR, () -> () -> new SizeRenderer(new HandcarBogeyRenderer(), StandardBogeyVisual::new))
    ...
    public static final BogeyStyle
        MEDIUM_STANDARD = create("medium_standard", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY, () -> () -> new SizeRenderer(new MediumStandardRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_SINGLE_WHEEL = create("medium_single_wheel", SINGLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_BOGEY, () -> () -> new SizeRenderer(new MediumSingleWheelRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_TRIPLE_WHEEL = create("medium_triple_wheel", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL, () -> () -> new SizeRenderer(new MediumTripleWheelRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_QUADRUPLE_WHEEL = create("medium_quadruple_wheel", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUADRUPLE_WHEEL, () -> () -> new SizeRenderer(new MediumQuadrupleWheelRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_QUINTUPLE_WHEEL = create("medium_quintuple_wheel", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUINTUPLE_WHEEL, () -> () -> new SizeRenderer(new MediumQuintupleWheelRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_2_0_2_TRAILING = create("medium_2_0_2_trailing", SINGLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_2_0_2_TRAILING, () -> () -> new SizeRenderer(new Medium202TrailingRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_4_0_4_TRAILING = create("medium_4_0_4_trailing", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_4_0_4_TRAILING, () -> () -> new SizeRenderer(new Medium404TrailingRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_6_0_6_TRAILING = create("medium_6_0_6_trailing", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL, () -> () -> new SizeRenderer(new Medium606TrailingRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_6_0_6_TENDER = create("medium_6_0_6_tender", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_TRIPLE_WHEEL, () -> () -> new SizeRenderer(new Medium606TenderRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_8_0_8_TENDER = create("medium_8_0_8_tender", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUADRUPLE_WHEEL, () -> () -> new SizeRenderer(new Medium808TenderRenderer(), StandardBogeyVisual::new))
            .build(),
        MEDIUM_10_0_10_TENDER = create("medium_10_0_10_tender", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.SMALL, CRBlocks.MEDIUM_QUINTUPLE_WHEEL, () -> () -> new SizeRenderer(new Medium10010TenderRenderer(), StandardBogeyVisual::new))
            .build();
    ...
    public static final BogeyStyle
        LARGE_CREATE_STYLED_0_4_0 = create("large_create_style_0_4_0", DOUBLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_4_0, () -> () -> new SizeRenderer(new LargeCreateStyled040Renderer(), StandardBogeyVisual::new))
            .build(),
        LARGE_CREATE_STYLED_0_6_0 = create("large_create_style_0_6_0", TRIPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_6_0, () -> () -> new SizeRenderer(new LargeCreateStyled060Renderer(), StandardBogeyVisual::new))
            .build(),
        LARGE_CREATE_STYLED_0_8_0 = create("large_create_style_0_8_0", QUADRUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_8_0, () -> () -> new SizeRenderer(new LargeCreateStyled080Renderer(), StandardBogeyVisual::new))
            .build(),
        LARGE_CREATE_STYLED_0_10_0 = create("large_create_style_0_10_0", QUINTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_10_0, () -> () -> new SizeRenderer(new LargeCreateStyled0100Renderer(), StandardBogeyVisual::new))
            .build(),
        LARGE_CREATE_STYLED_0_12_0 = create("large_create_style_0_12_0", SEXTUPLEAXLE_CYCLE_GROUP)
            ...
            .size(BogeySizes.LARGE, CRBlocks.LARGE_CREATE_STYLE_0_12_0, () -> () -> new SizeRenderer(new LargeCreateStyled0120Renderer(), StandardBogeyVisual::new))
            .build();
